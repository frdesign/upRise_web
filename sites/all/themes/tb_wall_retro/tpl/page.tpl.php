...
<div id="page" class="page-default <?php print isset($page['nucleus_skin_classes']) ? $page['nucleus_skin_classes'] : "";?>">
      ...
      <div class="grid-inner clearfix">
        <div id="header" class="clearfix">
          ...
          <div id="menu-bar-wrapper">         
            <div id="menu-bar-inner" class="grid-inner clearfix"> <?php print $menu_bar; ?> </div>            
          </div>
          <!-- //MAIN NAV -->
          <?php endif;?>
  ...
  <div id="main-wrapper" class="wrapper">
    <?php if ($menu_left = render($page['menu_left'])): ?>
      <!-- MENU LEFT -->
      ...
      <!-- /#MENU LEFT -->
    <?php endif; ?>  
    <div class="container main-container <?php print $menu_left ? "left-menu-existed " : ""?><?php print $grid; ?> clearfix">
      <?php if($messages || $page['help']): ?>
        <!-- HELP & MESSAGES -->
        <div id="system-messages-wrapper" class="wrapper <?php print nucleus_group_class("sidebar_first, content"); ?>">
          <div class="grid-inner clearfix">
      ...
      <div class="page-inner <?php print nucleus_group_class("sidebar_second, content"); ?>">
	    <div class="page-main-inner clearfix">
		<div class="page-inner-wrapper clearfix">
		<?php if ($mass_top = render($page['mass_top'])): ?>
			<!-- MASS TOP -->
			<div id="mass-top-wrapper" class="wrapper <?php print nucleus_group_class("sidebar_second, content"); ?>">
				<div class="grid-inner clearfix">
				  <?php print $mass_top; ?>
				</div>
			</div>
			<!-- /#MASS TOP -->
		  <?php endif; ?>
		<div class=" <?php print nucleus_group_class("sidebar_second, content"); ?>">
			<div class="content_page grid-inner clearfix">
				<?php if (($sidebar_second = render($page['sidebar_second'])) && $sidebar_second_width) : ?>
					<!-- SIDEBAR SECOND -->
					<div id="sidebar-second-wrapper" class="sidebar<?php print $sidebar_second_width; ?> grid grid-last">
						<div class="grid-inner clearfix">
	    ...
	    <?php if($back_to_top_display): ?>
              <a id="button-btt" title="<?php print t('Back to Top'); ?>" class="btn-btt" href="#Top"><?php print t('Top'); ?></a>
            <?php endif; ?>
      </div>
	  </div>
