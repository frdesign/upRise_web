...
<div id="article-<?php print $node->nid; ?>" class="article <?php print $classes; ?> clearfix"<?php print $attributes; ?>>
  <?php if ($tb_wall_retro_first_field): ?>
    <?php print($tb_wall_retro_first_field); ?>
  <?php endif; ?>
    ...
    <div class="header article-header clearfix">
      ...
      <?php if ($title): ?>
        <h2<?php print $title_attributes; ?>>
          <a class="<?php print $view_mode == 'teaser' ? "colorbox-load" : "";?>" href="<?php print $node_url;?>"><?php print $title;?></a>
        </h2>
      <?php endif; ?>
  ...
  <?php if ($display_submitted && $type != 'tb_social_feed' && $type != 'tb_theme_feed' && $type != 'tb_rss_feed'): ?>
